...
class Jadwalpelajaran extends CI_Controller
{
	...
	public function index()
	{
		...
		$kelas = $this->db->select('siswa.nis,ruang_kelas.nama_ruangan,ruang_kelas.id as id_kelas')->from('siswa')->join('ruang_kelas','ruang_kelas.id=siswa.id_kelas')->where('nis',$nik)->get()->row();
		// $kelas_siswa = $kelas->id_kelas;
		$kelas_siswa = $id_kelas->id_kelas;
