  ...
  <div class="wrapper">
    ...
    <!-- /.content -->
        <?php 
            ...
            ?>
            <form method="POST" action="<?=site_url('guru/nilai/store_ekskul');?>" class="form-horizontal">
              ...
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-2 control-label">Nama Ekskul</label>
                <div class="col-sm-10">
                  <select name="nama" class="form-control">
                    <option disabled selected="">Pilih Ekskul</option>
                    <?php foreach($ekskul as $mapel) : ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" maxlength="1" name="nilai" class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <P style="font-style: italic;">*Nilai A (80-100), B (60-79), C (0-59)</P>
                </div>
              </div>
