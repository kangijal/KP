                        ...
                        <div class="col-sm-offset-2 col-sm-8">
                            ...
                            <div class="panel-body">
                                <form action="<?php echo site_url('admin/lihatdata/updatemapel/'.$mapel->id);?>" method="POST" class="form-horizontal" role="form">                                    
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="example-email">Nama Mata Pelajaran</label>
                                        <div class="col-md-10">
                                            <input type="text" name="nama_mapel" value="<?= $mapel->nama_mapel;?>" id="example-email" class="form-control" placeholder="">
                                        </div>
                                    </div>
