...
<!-- Bootstrap Core CSS -->
<link href="<?php echo base_url('assets/novus/web/css/bootstrap.css');?>" rel='stylesheet' type='text/css' />
<!-- Custom CSS -->
<link href="<?php echo base_url('assets/novus/web/css/style.css');?>" rel='stylesheet' type='text/css' />
<!-- font CSS -->
<!-- font-awesome icons -->
<link href="<?php echo base_url('assets/novus/web/css/font-awesome.css');?>" rel="stylesheet"> 
<!-- //font-awesome icons -->
 <!-- js-->
<script src="<?php echo base_url('assets/novus/web/js/jquery-1.11.1.min.js');?>"></script>
<script src="<?php echo base_url('assets/novus/web/js/modernizr.custom.js');?>"></script>
<!--webfonts-->
<link href='//fonts.googleapis.com/css?family=Roboto+Condensed:400,300,300italic,400italic,700,700italic' rel='stylesheet' type='text/css'>
<!--//webfonts--> 
<!--animate-->
<link href="<?php echo base_url('assets/novus/web/css/animate.css');?>" rel="stylesheet" type="text/css" media="all">
<script src="<?php echo base_url('assets/novus/web/js/wow.min.js');?>"></script>
	<script>
		 new WOW().init();
	</script>
<!--//end-animate-->
<!-- chart -->
<script src="<?php echo base_url('assets/novus/web/js/Chart.js');?>"></script>
<!-- //chart -->
<!--Calender-->
<link rel="stylesheet" href="<?php echo base_url('assets/novus/web/css/clndr.css');?>" type="text/css" />
<script src="<?php echo base_url('assets/novus/web/js/underscore-min.js');?>" type="text/javascript"></script>
<script src= "<?php echo base_url('assets/novus/web/js/moment-2.2.1.js');?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/novus/web/js/clndr.js');?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/novus/web/js/site.js');?>" type="text/javascript"></script>
<!--End Calender-->
<!-- Metis Menu -->
<script src="<?php echo base_url('assets/novus/web/js/metisMenu.min.js');?>"></script>
<script src="<?php echo base_url('assets/novus/web/js/custom.js');?>"></script>
<link href="<?php echo base_url('assets/novus/web/css/custom.css');?>" rel="stylesheet">
<!--//Metis Menu -->
</head> 
<body class="cbp-spmenu-push">
			...
			<div class="main-page">
				...
				<div class="row">
					<div class="col-md-8 map widget-shadow">
						...
						<!--map js-->
						<link href="<?php echo base_url('assets/novus/web/css/jqvmap.css');?>" rel='stylesheet' type='text/css' />
						<script src="<?php echo base_url('assets/novus/web/js/jquery.vmap.js');?>"></script>
						<script src="<?php echo base_url('assets/novus/web/js/jquery.vmap.sampledata.js');?>" type="text/javascript"></script>
						<script src="<?php echo base_url('assets/novus/web/js/jquery.vmap.world.js');?>" type="text/javascript"></script>
	...
	<!-- Classie -->
		<script src="<?php echo base_url('assets/novus/web/js/classie.js');?>"></script>
		<script>
	...
	<!--scrolling js-->
	<script src="<?php echo base_url('assets/novus/web/js/jquery.nicescroll.js');?>"></script>
	<script src="<?php echo base_url('assets/novus/web/js/scripts.js');?>"></script>
	<!--//scrolling js-->
	<!-- Bootstrap Core JavaScript -->
   <script src="<?php echo base_url('assets/novus/web/js/bootstrap.js');?>"> </script>
</body>
</html>